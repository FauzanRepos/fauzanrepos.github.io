...
Recent release notes for the versions covered here. For the **complete** project history, see [`CHANGELOG.md` on GitHub](https://github.com/FauzanRepos/SwAN/blob/master/CHANGELOG.md).
